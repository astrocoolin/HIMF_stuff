...
for mass in (7.5, 8.3, 9.2, 10.5):
  for ba in (4,5,6,8,):
      for inc in (10,35,65,80,):
        namestr = str(mass)+"/ba_"+str(ba)+".0.mass_"+str(mass)+".inc_"+str(inc)+".0.SN_8.0.noise"
        saveloc = "ba_"+str(ba)+".0.mass_"+str(mass)+".inc_"+str(inc)+".0.SN_8.0.noise"
        num = np.arange(1,51)
        ...
        xy.append([[Total_Chi,Total_Bias,mass,ba,inc,success]])
        xy_f.append([[Total_Chi_f,Total_Bias_f,mass,ba,inc,success]])
        if plt1:
...
CB1 = axes[0,0].scatter((xy[:,0,1]),(xy[:,0,0]),c=xy[:,0,2],cmap='coolwarm')
...
CB2 = axes[0,1].scatter((xy[:,0,1]),(xy[:,0,0]),c=xy[:,0,3],cmap='coolwarm')
...
CB3 = axes[1,0].scatter((xy[:,0,1]),(xy[:,0,0]),c=xy[:,0,4],cmap='coolwarm')
...
CB4 = axes[1,1].scatter((xy[:,0,1]),(xy[:,0,0]),c=xy[:,0,5],cmap='coolwarm')
...
CB1 = axes[0,0].scatter((xy_f[:,0,1]),(xy_f[:,0,0]),c=xy_f[:,0,2],cmap='coolwarm')
cbar = fig.colorbar(CB1,ax=axes[0,0])
axes[0,0].set_xlabel('"Bias"',fontsize=21.5)
axes[0,0].set_ylabel('Chi2',fontsize=21.5)
axes[0,0].xaxis.set_tick_params(which='both', labelbottom=True)

CB2 = axes[0,1].scatter((xy_f[:,0,1]),(xy_f[:,0,0]),c=xy_f[:,0,3],cmap='coolwarm')
cbar = fig.colorbar(CB2,ax=axes[0,1])
axes[0,1].set_xlabel('"Bias"',fontsize=21.5)
axes[0,1].set_ylabel('Chi2',fontsize=21.5)
axes[0,1].xaxis.set_tick_params(which='both', labelbottom=True)

CB3 = axes[1,0].scatter((xy_f[:,0,1]),(xy_f[:,0,0]),c=xy_f[:,0,4],cmap='coolwarm')
cbar = fig.colorbar(CB3,ax=axes[1,0])
axes[1,0].set_xlabel('"Bias"',fontsize=21.5)
axes[1,0].set_ylabel('Chi2',fontsize=21.5)
axes[1,0].xaxis.set_tick_params(which='both', labelbottom=True)

CB4 = axes[1,1].scatter((xy_f[:,0,1]),(xy_f[:,0,0]),c=xy_f[:,0,5],cmap='coolwarm')
cbar = fig.colorbar(CB4,ax=axes[1,1])
axes[1,1].set_xlabel('"Bias"',fontsize=21.5)
axes[1,1].set_ylabel('Chi2',fontsize=21.5)
axes[1,1].xaxis.set_tick_params(which='both', labelbottom=True)
